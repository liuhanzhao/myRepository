...
public class UserController extends BaseController {
	...
	@ResponseBody
	public ResponseResult<Void> handleLog(@RequestParam("username") String username,
	...
	// 修改密码业务
	@RequestMapping(value = "/handle_changePwd.do", method = RequestMethod.POST)
	@ResponseBody
	public ResponseResult<Void> updataPwd(String oldPassword, String newPassword, HttpSession session) {
		...
		userService.updataPwd(username, oldPassword, newPassword);
		return new ResponseResult<Void>();

	}

	// 修改用户资料
	@RequestMapping(value = "/handle_updateInfo.do", method = RequestMethod.POST)
	@ResponseBody
	...
	// 获取用户信息
	@RequestMapping(value = "/handle_getInfo.do", method = RequestMethod.GET)
	@ResponseBody
	...
	@ResponseBody
	public ResponseResult<String> handleUpload(HttpServletRequest request,HttpSession session, @RequestParam("file") CommonsMultipartFile file) {
